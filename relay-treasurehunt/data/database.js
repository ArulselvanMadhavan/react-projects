...
function checkHidingSpotForTreasure(id){
...
function getHidingSpot(id){
    return hidingSpots.find(hs => hs.id === id)
}
function getGame(){ return game;}
function getHidingSpots(){ return hidingSpots;}
function getTurnsRemaining(){ return turnsRemaining;}
